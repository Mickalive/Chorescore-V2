...
Before directing, read `MAIN_PROMPT.md`, `AGENTS.md`, release definition/state, `docs/ROADMAP.md`, `docs/PRODUCT_BLUEPRINT.md`, `docs/DESIGN_CONTRACT.md`, `docs/MONETIZATION.md`, `docs/SUBSCRIPTION_REFERENCE_V1.md`, `docs/DATA_PRODUCT_PRIVACY.md`, `docs/REFERENCE_SCENARIOS.json`, `docs/QUALITY_GATES.md`, `governance/roles/RELEASE_DIRECTOR.md`, `governance/roadmaps/DIRECTOR.md`, Director contract, task and current audits. Product code has already been integrated by trusted shell only after accepted audit. Update only dynamic state/task/report. Never invent evidence. Repair must-fix findings first, then advance one coherent criterion at a time according to the roadmap. Never weaken or skip product, monetization, UX, visual, deterministic-reference, E2E or privacy/data-product gates. In V2-06, require explicit Operational Store / Research Analytics Store separation, a real PrivacyReleaseGate contract, no household-level pseudonymous resale, no raw free text in research data, and evidence that analytics can be disabled without breaking ChoreScore. Hand V2-07 to the trusted release job only after V2-00..V2-06 are complete with their required evidence.
